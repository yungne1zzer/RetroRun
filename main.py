...
def main():
    class Player(pygame.sprite.Sprite):
        def __init__(self):
            super().__init__()
            player_walk_1 = pygame.image.load('graphics/Player/my_1.png').convert_alpha()
            player_walk_2 = pygame.image.load('graphics/Player/my_2.png').convert_alpha()
            self.player_walk = [player_walk_1, player_walk_2]
            self.player_index = 0
            self.player_jump = pygame.image.load('graphics/Player/jump_1.png').convert_alpha()

            self.image = self.player_walk[self.player_index]
            self.rect = self.image.get_rect(midbottom = (100,315))
            self.gravity = 0
    ...
    pygame.display.set_caption('Retro Run')
    title_icon = pygame.image.load('logo.png')
    ...
    sky_surface = pygame.image.load('graphics/backgrounds.png').convert()
    ...
    player_index = 0
    player_jump = pygame.image.load('graphics/Player/jump_1.png').convert_alpha()
    ...
    #Intro screen
    player_stand = pygame.image.load('graphics/Player/my_stand.png').convert_alpha()
    player_stand = pygame.transform.scale2x(player_stand)
    player_stand_rect =  player_stand.get_rect(center=(400,200))

    game_name = test_font.render('Retro Run', False, "White")
    ...
    while True:
        for event in pygame.event.get():
            ...
            if game_active:
                if event.type == pygame.MOUSEBUTTONDOWN:
                    if player_rect.collidepoint(event.pos) and player_rect.bottom >= 315:
                        player_gravity = -22
            ...
            if game_active:
                if event.type == obstacle_timer:
                    ...
                    #else:
                    #    obstacles_rect_list.append(fly_surf.get_rect(bottomright=(randint(900, 1100), 255)))
        ...
        if game_active:
            ...
            #if player_rect.bottom >= 315: player_rect.bottom = 315
            #player_animation()
